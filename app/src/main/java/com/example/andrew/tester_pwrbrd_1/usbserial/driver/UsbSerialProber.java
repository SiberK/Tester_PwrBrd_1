...
//        @Override
//        public List<UsbSerialDriver> probe(final UsbManager manager, final UsbDevice usbDevice) {
//            if (!testIfSupported(usbDevice, HuaweiSerialDriver.getSupportedDevices())) {
//                return Collections.emptyList();
//            }
//            final UsbDeviceConnection connection = manager.openDevice(usbDevice);
//            if (connection == null) {
//                return Collections.emptyList();
//            }
//            final UsbSerialDriver driver = new HuaweiSerialDriver(usbDevice, connection);
//            return Collections.singletonList(driver);
//        }
//    },
//
...
//    },
    ...
    STM32_VCP {
        @Override
        public List<UsbSerialDriver> probe(final UsbManager manager, final UsbDevice usbDevice) {
            if (!testIfSupported(usbDevice, Stm32vcpSerialDriver.getSupportedDevices())) {
                return Collections.emptyList();
            }
            final UsbDeviceConnection connection = manager.openDevice(usbDevice);
            if (connection == null) {
            ...
            final UsbSerialDriver driver = new Stm32vcpSerialDriver(usbDevice, connection);
            return Collections.singletonList(driver);
        }
    };
