package com.example.andrew.oscilloscope_bt;
...
public class BluetoothService {
    ...
    public static final int MESSAGE_READ_STR = 2;
    public static final int MESSAGE_WRITE = 3;
    public static final int MESSAGE_DEVICE_NAME = 4;
    public static final int MESSAGE_TOAST = 5;
    public static final int MESSAGE_READ_BIN = 6;
    public static final int MESSAGE_READ_PACK = 7;
    ...
    /**
     * Constructor. Prepares a new BControl session.
  ...
  //===================================================================
    ...
    private class ConnectedThread extends Thread {
        ...
        private static final int	LenBFpack = 60000			;
        private static final int	LenBFstream = 1024			;
        int		Ix;
        byte[]	bufferSt;
      //===================================================================
        ...
        private int				IxPack=0,LenPack=0,SignPack=0,FrameIx,PrevFrameIx=0	;
        private	long			mTime0, mTime1					;
//------------------------------------------------------------------------
        protected void ParsePack(byte[] readBuf,int Count) {
            int		ix			;
...
//                      LenPack = shBuff.get(2);
    ...
    //===================================================================
        ...
        public void run() {
            ...
            byte[] buffer = new byte[LenBFstream];
            int bytes,ix;
